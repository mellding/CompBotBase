...
public class DriveTrain extends SubsystemBase {
    ...
    private static final CANSparkMax leftPrimary     = new CANSparkMax(Constants.LEFT_DRIVE_PRIMARY_CAN_ID, MotorType.kBrushless);
    private static final CANSparkMax leftSecondary   = new CANSparkMax(Constants.LEFT_DRIVE_SECONDARY_CAN_ID, MotorType.kBrushless);
    private static final CANSparkMax rightPrimary    = new CANSparkMax(Constants.RIGHT_DRIVE_PRIMARY_CAN_ID, MotorType.kBrushless);
    private static final CANSparkMax rightSecondary  = new CANSparkMax(Constants.RIGHT_DRIVE_SECONDARY_CAN_ID, MotorType.kBrushless);  
